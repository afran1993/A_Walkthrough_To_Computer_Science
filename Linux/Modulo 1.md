...
| **Debian** | <img src="[https://upload.wikimedia.org/wikipedia/commons/6/66/Openlogo-debian.svg](https://upload.wikimedia.org/wikipedia/commons/6/66/Openlogo-debianV2.svg)" width="40"> | Una delle distro più vecchie, focalizzata su stabilità granitica e software libero. | Utilizzata principalmente per server e infrastrutture critiche. |
